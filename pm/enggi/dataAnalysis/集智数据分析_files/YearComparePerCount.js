var drawChartYearComparePerCount = function (data) {
    $(function () {
    ...
    if (data.series[0].percount[0].data.length>0)
    {
        $('#containerBuickPerCount').highcharts({
            chart: {
                type: 'spline',
            },
            title: {
                text: data.year + '年客单价分析'
            },
            xAxis: {
                categories: data.x,
                crosshair: true
